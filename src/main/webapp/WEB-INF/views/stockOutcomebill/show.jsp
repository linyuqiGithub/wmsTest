...
<head>
    ...
    <script type="text/javascript" src="/js/plugins/artDialog/jquery.artDialog.js?skOut=blue"></script>
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:textfield name="stockOutcomebill.depot.name" cssClass="ui_input_txt02"></s:textfield>
                    </td>
                </tr>
                <tr>
