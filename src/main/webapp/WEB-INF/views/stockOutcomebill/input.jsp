...
<s:form name="editForm" namespace="/" action="stockOutcomebill_saveOrUpdate" method="post" id="editForm" theme="simple">
    <div id="container">
        <div id="nav_links">
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                如果是编辑,该id有值,可以封装进action中的stockOutcomebill对象中
                则调用update方法--%>
                <s:hidden name="stockOutcomebill.id"></s:hidden>
                <tr>
                    <td class="ui_text_rt" width="140">出库单编号</td>
                    <td class="ui_text_lt">
                        <%--如果root中stockOutcomebill对象不为空,则可以用于数据回显--%>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        ...
                        <%--该id值将设置进stockOutcomebill的depot关联对象中--%>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        ...
                        <s:date name="stockOutcomebill.vdate" var="vdate" format="yyyy-MM-dd"/>
                        <s:textfield name="stockOutcomebill.vdate" class="ui_input_txt02" value="%{#vdate}"/>
                    </td>
                </tr>
                <tr>
                            ...
                            <s:if test="stockOutcomebill.id == null">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <%--将数据封装到stockOutcomebill中的stockOutcomebillItem集合中
                                        提交页面后stockOutcomebill中的明细集合就有值了,siz不为0,--%>
