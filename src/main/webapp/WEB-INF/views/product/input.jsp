...
<%--表单提交中若包含文件上传,需要在form中加上enctype="multipart/form-data"--%>
<s:form name="editForm" namespace="/" action="product_saveOrUpdate" method="post" id="editForm" theme="simple" enctype="multipart/form-data">
    <div id="container">
        <div id="nav_links">
            <span style="color: #1A5CC6;">product编辑</span>
            <div id="page_close">
                <a>
                ...
                <s:hidden name="product.id"></s:hidden>
                            ...
                            <tr>
                                ...
                                <td class="ui_text_lt">
                                    ...
                                    <img src="<s:property value="product.smallImagePath"/>"  width="50px" class="list_img_min">
                                </td>
                            </tr>
                            <tr>
                                <td class="ui_text_rt" width="140">货品介绍</td>
                                <td class="ui_text_lt">
                                    <s:textfield name="product.intro" cssClass="ui_input_txtarea" ></s:textfield>
                                </td>
                            </tr>
                <tr>
                    <td>&nbsp;</td>
