					...
					<td class="ui_text_lt">
						<table>
							...
							<tr>
								<td>
								<%-- 所有的菜单 --%>
								<s:select list="#menus" name="" listKey="id" listValue="name" multiple="true" cssClass="ui_multiselect01 all_menus"/>
								</td>
								<td align="center">
								...
								<td>
								<%-- 当前角色可以查看的菜单 --%>
									<s:select name="role.menus.id" list="role.menus" listKey="id" listValue="name" multiple="true" cssClass="ui_multiselect01 selected_menus"/>
								</td>
							</tr>
						</table>
					</td>
